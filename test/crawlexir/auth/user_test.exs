defmodule Crawlexir.Auth.UserTest do
  ...
  @valid_attributes %{email: "jean@bon.com", first_name: "Jean", last_name: "Bon", password: "12345678"}

  describe "validation" do
    test "requires all fields" do
      changeset = User.changeset(%User{}, %{email: nil, first_name: nil, last_name: nil, password: nil})
